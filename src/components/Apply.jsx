...
<div class="mb-6">
  ...
  <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">How can we reach you the best? *</label>
    <input type="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Instagram/Telegram/WhatsApp"/>
    </div>



    <div class="mb-6">
    <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">What language do you speak?</label>
...
<div class="flex items-center mb-4">
    ...
    <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">What else should we know about you</label>
