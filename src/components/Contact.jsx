...
<div id="contact" className="mb-10"><br /> </div>
<div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 mt-10">

      
<h1 className=" text-center mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Contact</h1>
<p className=" text-center mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Are you a model who values consistency, and want to work with us?</p>
